...
#     "instruction": "什么是宝源局?",
#     "input": "",
#     "output": "宝源局是官署名。明、清工部所属铸钱机构。元至元二十一年(1361年)朱元璋于应天初设。明洪武十三年(1380年)隶工部。嘉靖年间京师置鼓铸公署,以虞衡司员外郎领其事。下设局大使、副大使各一人。铸造通宝钱文。清顺治元年(1644年)复置,归工部钱法堂统辖。设满、汉监督各一人,下属案房、兑房、钱房、算房、循环房等办事机构。掌监收铜铅及铸钱之事。光绪三十二年(1906年)改隶度支部。"
# }
...
parser.add_argument("--data_path", type=str, default="train_cishu.json")
